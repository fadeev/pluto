...
import (
	...
	appparams "github.com/fadeev/pluto/app/params"
	"github.com/fadeev/pluto/x/pluto"
	plutokeeper "github.com/fadeev/pluto/x/pluto/keeper"
	plutotypes "github.com/fadeev/pluto/x/pluto/types"
...
var (
	...
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/plutod")
	}
...
type App struct {
	*baseapp.BaseApp
	...
	plutoKeeper plutokeeper.Keeper
...
func New(
	...
	app.plutoKeeper = *plutokeeper.NewKeeper(
        appCodec, keys[plutotypes.StoreKey], keys[plutotypes.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		transferModule,
		pluto.NewAppModule(appCodec, app.plutoKeeper),
